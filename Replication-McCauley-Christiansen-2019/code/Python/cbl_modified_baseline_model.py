...
class CBL_Model:
    ...
    def __init__(self):
        ...
        self.UniChunks = {}
        self.BiChunks = {}
        #MOD : made spa into dict which collects prod scores for sent lengths separately
        self.spa = dict()
        #MOD : made spa into dict which collects prod scores for sent lengths separately
    ...
    def big_spa(self, utterance):
        ...
        if ' '.join(produced) == ' '.join(line):
            #MOD : increment count at key in dict
...
for subdir, dirs, files in os.walk(rootdir):
    for file in files:
        if ('.capp' in file):
            ...
            i = 1
            outputfile = open(rootdir+'results/cbl-baseline/prod_results/'+file.split('.capp')[0]+'.prod_result.csv','w')
